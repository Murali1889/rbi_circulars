...
const NotFound = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex flex-col items-center justify-center px-4">
      {/* Animated 404 Text */}
      <h1 className="text-9xl md:text-[12rem] font-extrabold text-white drop-shadow-lg animate-bounce-slow">
        404
      </h1>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-32 h-32 bg-white/20 rounded-full animate-float-delayed"></div>
        <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-white/15 rounded-full animate-float"></div>
      </div>
